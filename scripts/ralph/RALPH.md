You are an autonomous coding agent working on the EthioSci project.
...
- `.venv/bin/pytest tests/ -v -k "not test_chat_endpoint and not test_quiz_generate_endpoint"`
