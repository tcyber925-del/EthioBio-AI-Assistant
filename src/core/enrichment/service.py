...
STOPWORDS: set[str] = {
    ...
    "its", "they", "them", "their", "we", "you", "he", "she", "who",
    "which", "what", "when", "where", "why", "how", "all", "each",
    "every", "both", "few", "some", "any", "no", "not", "so", "if",
    "then", "than", "too", "very", "just", "about", "up", "down", "out",
    "off", "over", "under", "again", "further", "once", "here", "there",
    "into", "onto", "upon", "within", "without", "also", "more", "most",
    "other", "such", "only", "own", "same", "because", "before", "after",
    "between", "through", "during", "since", "until", "while", "like",
    "although", "though", "while", "whereas", "rather", "than", "except",
    "even", "still", "yet", "already", "almost", "quite", "really",
    "well", "much", "many", "long", "much", "able", "according", "across",
    "actually", "afterwards", "almost", "alone", "along", "already",
    "always", "among", "amongst", "amount", "another", "anything",
    "anyway", "anywhere", "around", "back", "become", "becomes",
    "becoming", "beside", "besides", "beyond", "bottom", "call", "came",
    "can", "cant", "cause", "certain", "clearly", "come", "couldnt",
    "de", "describe", "detail", "done", "due", "during", "e.g", "eight",
    "either", "eleven", "else", "elsewhere", "empty", "enough", "etc",
    "ever", "everyone", "everything", "everywhere", "face", "fact",
    "fifteen", "fify", "fill", "find", "fire", "five", "former",
    "formerly", "found", "four", "front", "full", "further", "get",
    "give", "go", "got", "group", "hence", "here", "hereafter",
    "hereby", "herein", "hereupon", "herself", "himself", "hither",
    "however", "hundred", "indeed", "instead", "itself", "keep",
    "latter", "latterly", "least", "less", "lest", "made", "make",
    "make", "making", "maybe", "mean", "meanwhile", "merely", "might",
    "mine", "miss", "moreover", "mostly", "move", "myself", "namely",
    "neither", "nevertheless", "next", "nine", "nobody", "none",
    "nothing", "nowhere", "obtain", "often", "onto", "ourselves",
    "otherwise", "part", "per", "perhaps", "please", "poorly",
    "possible", "presumably", "previous", "previously", "promptly",
    "put", "rather", "readily", "really", "regarding", "regardless",
    "regards", "result", "said", "same", "seem", "seemed", "seeming",
    "seems", "serious", "several", "shall", "shed", "shes", "show",
    "showed", "shown", "shows", "side", "significant", "sincere",
    "six", "sixty", "somehow", "someone", "something", "sometime",
    "sometimes", "somewhere", "state", "strongly", "substantially",
    "successfully", "sufficiently", "tell", "ten", "th", "thee", "their",
    "them", "themselves", "thence", "thereafter", "thereby", "therefor",
    "therein", "thereupon", "thick", "thin", "third", "thorough",
    "thoroughly", "though", "three", "throughout", "thru", "thus",
    "together", "top", "toward", "towards", "twelve", "twenty", "two",
    "un", "under", "unless", "unlike", "unlikely", "until", "upon",
    "us", "used", "useful", "usefully", "usefulness", "using",
    "usually", "various", "via", "viz", "volume", "way", "yours",
    "yourself", "yourselves",
}
