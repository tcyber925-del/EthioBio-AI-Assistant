TEACHER_INTENTS = {
    "student_analysis": {
        "keywords": [
            "student", "hana", "why is", "struggling",
            "performance", "mastery", "progress",
        ],
        "description": "Individual student performance analysis",
    },
    "classroom_analysis": {
        "keywords": [
            "classroom", "class", "who needs", "attention",
            "trends", "overview", "summary",
        ],
        "description": "Classroom-wide intelligence and trends",
    },
    "intervention_guidance": {
        "keywords": [
            "intervention", "what should i do", "help",
    ...
    "curriculum_analysis": {
        "keywords": [
            "curriculum", "prerequisite", "topic",
            "what comes next", "coverage", "sequence",
        ],
