  ...
  theme: {
    extend: {
      colors: {
        ...
        'v2-purple': 'var(--v2-purple)',
        'v2-purple-rule': 'var(--v2-purple-rule)',
        'v2-mint-border': 'var(--v2-mint-border)',
        'v2-link-hover': 'var(--v2-link-hover)',
        'v2-focus': 'var(--v2-focus)',
        'v2-inverted': 'var(--v2-inverted)',
        'v2-image-frame': 'var(--v2-image-frame)',
